...
import { ref, watch, defineComponent, shallowRef, markRaw, computed, watchEffect, createApp, nextTick, onMounted, onBeforeUnmount, unref, useSSRContext } from "vue";
...
import { unrefElement, tryOnScopeDispose, computedAsync, useSessionStorage, useLocalStorage, debouncedWatch, onKeyStroke, useEventListener, useScrollLock } from "@vueuse/core";
...
import "./HeroCodeGroup.ec57TU07.js";
import "codesandbox/lib/api/define.js";
import "@stackblitz/sdk";
import "./index.faJ9MUPN.js";
import "@iconify/vue";
import "./index.0Y0dHuZY.js";
import "./index.ssJzD7KM.js";
import "./index.qt3zUPQo.js";
import "./index.lL3S7tgu.js";
import "./index.rQ-nPtIV.js";
import "./index.Jln7eolS.js";
import "./index.baB2ti6k.js";
import "./index.nYYZtszG.js";
import "./index.gcJMds_m.js";
import "./index.xv26BsCr.js";
import "./index.sPK3_V7F.js";
import "./index.XHDnbhzh.js";
import "./index.-yxHsJEj.js";
import "./index.oq195dYj.js";
import "./index.SkyMgy3T.js";
import "./index.QSnAocj3.js";
import "./index.vkG0bUDg.js";
import "./index.xAj7wet3.js";
import "./index.PizxzUMs.js";
import "./index.-wAv1UcI.js";
import "./index.YA8Ot0vp.js";
import "./index.WjsV5DJ5.js";
import "./index.xt90WszU.js";
import "./index.isrVVGwd.js";
import "./index.7SwdZVsi.js";
import "./index.ZQdK7v4E.js";
import "./index.LXkbS4pL.js";
import "./index.PfQkVDQx.js";
import "./index.3KVMrJIL.js";
import "./index.0fshOh8W.js";
import "./index.mteCbIyP.js";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.W8tjN3ZY.js") };
/*!
* tabbable 6.2.0
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a3, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a3 = results.value) == null ? void 0 : _a3.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-0d313eeb><div class="backdrop" data-v-0d313eeb></div><div class="shell" data-v-0d313eeb><form class="search-bar" data-v-0d313eeb><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-0d313eeb><svg class="search-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-0d313eeb><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-0d313eeb><circle cx="11" cy="11" r="8" data-v-0d313eeb></circle><path d="m21 21l-4.35-4.35" data-v-0d313eeb></path></g></svg></label><div class="search-actions before" data-v-0d313eeb><button class="back-button"${ssrRenderAttr("title", unref($t)("modal.backButtonTitle"))} data-v-0d313eeb><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m7 7l-7-7l7-7" data-v-0d313eeb></path></svg></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-0d313eeb><div class="search-actions" data-v-0d313eeb>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref($t)("modal.displayDetails"))} data-v-0d313eeb><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 14h7v7H3zM3 3h7v7H3zm11 1h7m-7 5h7m-7 6h7m-7 5h7" data-v-0d313eeb></path></svg></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref($t)("modal.resetButtonTitle"))} data-v-0d313eeb><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 5H9l-7 7l7 7h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Zm-2 4l-6 6m0-6l6 6" data-v-0d313eeb></path></svg></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-0d313eeb><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-0d313eeb><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-0d313eeb><div data-v-0d313eeb><div class="titles" data-v-0d313eeb><span class="title-icon" data-v-0d313eeb>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-0d313eeb><span class="text" data-v-0d313eeb>${t}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-0d313eeb></path></svg></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-0d313eeb><span class="text" data-v-0d313eeb>${p.title}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-0d313eeb>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-0d313eeb><div class="vp-doc" data-v-0d313eeb>${p.text}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-0d313eeb></div><div class="excerpt-gradient-top" data-v-0d313eeb></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-0d313eeb>${ssrInterpolate(unref($t)("modal.noResultsText"))} &quot;<strong data-v-0d313eeb>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-0d313eeb><span data-v-0d313eeb><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateUpKeyAriaLabel"))} data-v-0d313eeb><svg width="14" height="14" viewBox="0 0 24 24" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-0d313eeb></path></svg></kbd><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateDownKeyAriaLabel"))} data-v-0d313eeb><svg width="14" height="14" viewBox="0 0 24 24" data-v-0d313eeb><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-0d313eeb></path></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.navigateText"))}</span><span data-v-0d313eeb><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.selectKeyAriaLabel"))} data-v-0d313eeb><svg width="14" height="14" viewBox="0 0 24 24" data-v-0d313eeb><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-0d313eeb><path d="m9 10l-5 5l5 5" data-v-0d313eeb></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-0d313eeb></path></g></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.selectText"))}</span><span data-v-0d313eeb><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.closeKeyAriaLabel"))} data-v-0d313eeb>esc</kbd> ${ssrInterpolate(unref($t)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/vitepress@1.0.0-rc.40_patch_hash=vch4e6zq55wljc7ph3vsefnawq_@algolia+client-search@4.22.1_@ty_cpywouop5vln4rtagwwqvxuyge/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d313eeb"]]);
export {
