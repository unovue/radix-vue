...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/AccordionItem.md","filePath":"meta/AccordionItem.md","lastUpdated":1706867366000}');
const _sfc_main = { name: "meta/AccordionItem.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/AccordionItem.md");
