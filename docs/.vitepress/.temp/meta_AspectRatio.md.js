...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/AspectRatio.md","filePath":"meta/AspectRatio.md","lastUpdated":1706867366000}');
const _sfc_main = { name: "meta/AspectRatio.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/AspectRatio.md");
