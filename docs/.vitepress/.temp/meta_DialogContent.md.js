...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DialogContent.md","filePath":"meta/DialogContent.md","lastUpdated":1707194461000}');
const _sfc_main = { name: "meta/DialogContent.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/DialogContent.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DialogContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  DialogContent as default
};
