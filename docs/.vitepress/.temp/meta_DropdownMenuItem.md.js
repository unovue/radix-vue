...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DropdownMenuItem.md","filePath":"meta/DropdownMenuItem.md","lastUpdated":1706592413000}');
const _sfc_main = { name: "meta/DropdownMenuItem.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/DropdownMenuItem.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DropdownMenuItem = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
