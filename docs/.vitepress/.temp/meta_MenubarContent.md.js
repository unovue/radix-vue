...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/MenubarContent.md","filePath":"meta/MenubarContent.md","lastUpdated":1707212589000}');
const _sfc_main = { name: "meta/MenubarContent.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/MenubarContent.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MenubarContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  MenubarContent as default
};
