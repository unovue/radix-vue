...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/SelectContent.md","filePath":"meta/SelectContent.md","lastUpdated":1706673096000}');
const _sfc_main = { name: "meta/SelectContent.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/SelectContent.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SelectContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  SelectContent as default
};
