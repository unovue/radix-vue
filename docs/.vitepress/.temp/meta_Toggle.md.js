...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/Toggle.md","filePath":"meta/Toggle.md","lastUpdated":1706592413000}');
const _sfc_main = { name: "meta/Toggle.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/Toggle.md");
