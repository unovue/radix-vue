...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/ToggleGroupRoot.md","filePath":"meta/ToggleGroupRoot.md","lastUpdated":1706867366000}');
const _sfc_main = { name: "meta/ToggleGroupRoot.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("meta/ToggleGroupRoot.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ToggleGroupRoot = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  ToggleGroupRoot as default
};
