...
<template>
  <AlertDialogRoot>
    <AlertDialogTrigger asChild
      class="!bg-white !text-black hover:bg-black/10 !shadow-sm inline-flex h-[35px] items-center justify-center rounded-[4px] bg-white px-[15px] font-medium leading-none shadow-[0_2px_10px] outline-none focus:shadow-[0_0_0_2px] focus:shadow-black"
    >
    <button>
      Delete account
    </button>
