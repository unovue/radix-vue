...
<PropsTable :data="[
  ...
  {
    'name': 'modelValue',
    'description': '<p>The controlled value of the Combobox. Can be binded with <code>v-model</code>.</p>\n',
    'type': 'AcceptableValue | AcceptableValue[]',
    'required': false
  },
  {
  ...
  {
    'name': 'searchTerm',
    'description': '<p>The controlled search term of the Combobox. Can be binded with <code>v-model:searchTerm</code>.</p>\n',
    'type': 'string',
    'required': false
  },
  {
