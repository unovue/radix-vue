export { injectDateRangePickerRootContext, default as DateRangePickerRoot, type DateRangePickerRootProps, type DateRangePickerRootEmits } from './DateRangePickerRoot.vue'
