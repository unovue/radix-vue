...
<template>
  <Story title="Select" :layout="{ type: 'grid', width: '50%' }">
    <Variant title="default">
      <SelectRoot v-model="fruit">
        <SelectTrigger
          class="w-[133px] inline-flex items-center justify-between rounded px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-white text-violet11 shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-violet9 outline-none"
