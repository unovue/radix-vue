...
<template>
  <Story title="Toast/From Dialog" :layout="{ type: 'single', iframe: false }">
    <ToastProvider>
      <DialogRoot>
        ...
        <DialogContent :style="{ border: '1px solid', width: 300, padding: 30 }">
          ...
          <button class="inline-flex items-center justify-center rounded font-medium text-[15px] px-[15px] leading-[35px] h-[35px] bg-white text-violet11 shadow-[0_2px_10px] shadow-blackA7 outline-none hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black" @click="open = true">
            Open toast
          </button>
      ...
      <ToastRoot v-model:open="open" class="flex items-center space-between pointer-events-auto">
