<script lang="ts">
import type { TooltipProvideValue } from "./TooltipRoot.vue";
import type { TooltipContentProvideValue } from "./TooltipContent.vue";

interface TooltipArrowProps {
  size?: number;
  injectedValue?: TooltipProvideValue;
  injectedContentValue?: TooltipContentProvideValue
}
</script>
...
const injectedValue = props.injectedValue;

const injectedContentValue = props.injectedContentValue;
